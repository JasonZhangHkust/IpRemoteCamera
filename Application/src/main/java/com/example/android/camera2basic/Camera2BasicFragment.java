...
public class Camera2BasicFragment extends Fragment
    ...
    final static int APPS_PORT = 1234;
    final static byte  MSG_PICTURE_CAPTURE= (byte)'P';
    TextView tvIp;
    TextView tvState;
                        ...
                        for (int i = 0; i < length; i++) {
                            ...
                            switch(data[i]) {
                                case MSG_PICTURE_CAPTURE :
                                    //Toast.makeText(getActivity(), "hello the world", Toast.LENGTH_SHORT).show();
                                    //Log.i("hhh", "handleMessage: niho");
    ...
    private void takePicture() {
        //Toast.makeText(getActivity(), "hello here", Toast.LENGTH_SHORT).show();
        lockFocus();
    }
